...
public class ItemRubyBow extends Item
{
    ...
    {
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Items.arrow) || par3EntityPlayer.getHealth() == par3EntityPlayer.getMaxHealth())
        {
