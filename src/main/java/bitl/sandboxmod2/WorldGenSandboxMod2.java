...
public class WorldGenSandboxMod2 implements IWorldGenerator
{
    ...
    {
    	System.out.println("Running 'Sandbox Mod 2' world generator for the End.");
    }
    ...
    {
    	System.out.println("Running 'Sandbox Mod 2' world generator for the Nether.");
    }
